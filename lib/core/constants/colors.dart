...
const Color streamLightBlue = Color.fromRGBO(239, 243, 255, 1.0);
const Color streamDarkBlue = Color.fromRGBO(0, 85, 255, 1.0);
const Color streamDarkBlueText = Color.fromRGBO(41, 70, 140, 1.0);
const Color aiLightOrange = Color.fromRGBO(255, 239, 237, 1);
const Color aiDarkOrange = Color.fromRGBO(252, 76, 27, 1);
const Color aiDarkOrangeText = Color.fromRGBO(196, 42, 0, 1);
